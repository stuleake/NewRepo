...
namespace Api.Admin
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var storageManager = StorageProvider.CreateManager(connection, CT.Storage.Enum.ConnectionTypes.ConnectionString, 60);
           ...
           .AddJwtBearer(jwtOptions =>
            ...
            services.AddHttpClient<IPP2HttpClient, Core.Services.PP2.PP2HttpClient>(c =>
            {
                c.BaseAddress = new Uri(Configuration["ApiUri:PP2:BaseUrl"]);
            });

            services.AddHttpClient<IFeeCalculatorClient, FeeCalculatorClient>(c =>
            {
                c.BaseAddress = new Uri(Configuration["ApiUri:FeeCalculator:BaseUrl"]);
            });

            services.AddTransient<IB2CGraphClient, B2CGraphClient>();
            services.AddTransient<IDynamicHtmlPage, DynamicHtmlPage>();

            services.AddScoped<IB2CGraphClient>(c =>
            {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Terra Quest Admin API",
                    Description = "This API holds business logic related to the admin app"
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("../swagger/v1/swagger.json", "Terra Quest API");
            });
        }
