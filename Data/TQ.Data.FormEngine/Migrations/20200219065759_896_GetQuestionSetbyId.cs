...
namespace TQ.Data.FormEngine.Migrations
{
    ...
    public partial class _896_GetQuestionSetbyId : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var strGetQuestionSetbyIdProc = @"CREATE PROCEDURE [dbo].[GetQuestionSetbyId] @QuestionSetId UNIQUEIDENTIFIER
         AS
           BEGIN
               SELECT qs.qsid,
                      qs.qsno,
        ...
        {
            var strGetQuestionSetbyIdProc = "DROP PROCEDURE [dbo].[GetQuestionSetbyId];";
            strGetQuestionSetbyIdProc = strGetQuestionSetbyIdProc.Replace("'", "''");
            migrationBuilder.Sql($"EXEC ('{strGetQuestionSetbyIdProc}')");
        }
    }
