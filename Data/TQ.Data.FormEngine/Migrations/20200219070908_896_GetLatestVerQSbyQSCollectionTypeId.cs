...
namespace TQ.Data.FormEngine.Migrations
{
    ...
    public partial class _896_GetLatestVerQSbyQSCollectionTypeId : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var strGetQuestionSetbyIdProc = @"CREATE PROCEDURE [dbo].[GetLatestVerQSbyQSCollectionTypeId]
        ...
        {
            var strGetQuestionSetbyIdProc = "DROP PROCEDURE [dbo].[GetLatestVerQSbyQSCollectionTypeId];";
            strGetQuestionSetbyIdProc = strGetQuestionSetbyIdProc.Replace("'", "''");
            migrationBuilder.Sql($"EXEC ('{strGetQuestionSetbyIdProc}')");
        }
    }
