...
namespace UnitTest.CT.KeyVault.Managers
{
    ...
    public class ServicePricipalTest
    {
        private readonly IConfigurationRoot config;

        public ServicePricipalTest()
        {
        ...
        private IVaultManager SetupVaultManager()
        {
            ...
            var vaultMgr = VaultManagerProvider.CreateKeyVaultManager(KeyVaultTypes.ServicePrincipal, config["KeyVaultURL"]);
