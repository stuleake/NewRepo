...
{
    /// <summary>
    /// Unit tests for the <see cref="GetFullAddressesByPostcodeHandler"/> class
    /// </summary>
    [ExcludeFromCodeCoverage]
    public class GetFullAddressesByPostcodeHandlerTests
    {
        ...
        {
            // Arrange
            var request = new GetFullAddressByPostcodeCommand { Postcode = string.Empty };
        ...
        {
            // Arrange
            var request = new GetFullAddressByPostcodeCommand { Postcode = "invalid postcode" };
        ...
        {
            // Arrange
            var request = new GetFullAddressByPostcodeCommand { Postcode = ValidPostcode, Country = string.Empty };
        ...
        {
            // Arrange
            var request = new GetFullAddressByPostcodeCommand { Postcode = ValidPostcode, Country = "Invalid Country" };

            this.configuration = UnitTestHelper.BuildConfiguration(new Dictionary<string, string>
            {
                { "ApiUri:Geocoding:BaseUrl", "\\requestUrl" },
            });
        ...
        {
            // Arrange
            var request = new GetFullAddressByPostcodeCommand { Postcode = ValidPostcode, Country = CountryConstants.England, AuthToken = "Auth token" };
            ServiceResponse<IEnumerable<FullAddressSearchModel>> serviceResponse = null;
            ...
            Mock.Arrange(() => mockGeocodingClient.GetFullAddressByPostCodeAsync(Arg.AnyString, Arg.AnyString)).Returns(Task.FromResult(serviceResponse)).MustBeCalled();
            ...
            Mock.Assert(() => mockGeocodingClient.GetFullAddressByPostCodeAsync(Arg.AnyString, Arg.AnyString), Occurs.Once());
        }
        ...
        {
            // Arrange
            var request = new GetFullAddressByPostcodeCommand { Postcode = ValidPostcode, Country = CountryConstants.Wales };
            ServiceResponse<IEnumerable<FullAddressSearchModel>> serviceResponse = null;
        ...
        {
            // Arrange
            var request = new GetFullAddressByPostcodeCommand { Postcode = ValidPostcode, Country = CountryConstants.England };
            var serviceResponse = new ServiceResponse<IEnumerable<FullAddressSearchModel>>
            {
        ...
        public async Task HandleSuccessEnglish()
        {
            ...
            var serviceResponse = new ServiceResponse<IEnumerable<FullAddressSearchModel>>
            {
                ...
                Value = new List<FullAddressSearchModel>()
            };
        ...
        private GetFullAddressesByPostcodeHandler CreateSut()
        {
            return new GetFullAddressesByPostcodeHandler(mockGeocodingClient, configuration);
        }
    }
}